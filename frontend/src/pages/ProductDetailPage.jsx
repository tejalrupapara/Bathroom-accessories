  ...
  if (!product) {
    return (
      <div className="pdp-not-found">
        ...
        <Link to="/collection" className="btn btn-gold px-4 py-2">
          ← Back to Collection
        </Link>
      </div>
    );
      ...
      <div className="container-xxl pdp-main">
        <div className="row g-5 align-items-start">
          ...
          <div className="col-lg-6">
            <div
              className="pdp-image-card pdp-3d-card"
              onMouseMove={handleTilt}
              onMouseLeave={resetTilt}
            >
              <span className="pdp-card-shine" />
              ...
              <div
                className="pdp-series-tag"
                style={{
                  background: series.bg || "rgba(201,168,76,0.12)",
                  color: series.accent || "#c9a84c",
                }}
              >
            ...
            <div className="pdp-details">
              ...
              <div className="pdp-specs">
                ...
                <div className="pdp-spec-row">
                  ...
                  <span className="pdp-spec-value">
                    Nexxora by Greenvolt Enterprise
                  </span>
                </div>
              </div>
              ...
              <div className="pdp-finishes">
                ...
                <div className="pdp-finish-chips">
                  {[
                    { n: "Black", c: "#1a1a1a", t: "#fff" },
                    { n: "Rose Gold", c: "#b76e79", t: "#fff" },
                    { n: "Gold", c: "#c9a84c", t: "#1a1a1a" },
                  ].map((f) => (
                    <span
                      key={f.n}
                      className="pdp-finish-chip"
                      style={{
                        background: f.c,
                        color: f.t,
                      }}
              ...
              <div className="pdp-actions">
                <button
                  ...
                  onClick={() =>
                    added ? removeFromQuote(product.id) : addToQuote(product)
                  }
                >
                  {added ? (
                    <>
                ...
                <a
                  href={`https://wa.me/919998664704?text=Hi%2C%20I%20am%20interested%20in%20${encodeURIComponent(
                    product.name
                  )}%20(${product.id})%20from%20Nexxora.`}
                  target="_blank"
          ...
          <div className="container-xxl">
            <div className="pdp-related-header">
              <h2 className="section-heading">
                More from {product.category} Series
              </h2>

              <Link to="/collection" className="pdp-view-all">
                View All →
              </Link>
            </div>
            ...
            <div className="pdp-related-grid">
              {related.map((p) => (
                <Link
                  key={p.id}
                  to={`/product/${p.id}`}
                  className="pdp-related-card pdp-3d-mini"
                >
